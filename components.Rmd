...
code in each of these blocks.  mrgsolve will parse these blocks and augment
this code with the necessary elements to create the `C++` function.
...
used to initialize variables and get them set up proior to starting on 
the problem. 
